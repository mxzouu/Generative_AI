...
- `record_decision(client_id, demande_id, decision, commentaire)` — enregistre la décision.
...
- N'appelle **`record_decision` QUE** lorsque le conseiller a explicitement énoncé sa décision.
  Ne décide jamais de ta propre initiative.
